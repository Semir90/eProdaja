...
namespace eProdaja.Database
{
    public partial class eProdajaContext : DbContext
    {
        ...
        public virtual DbSet<CovidPasos> CovidPasos { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CovidPasos>(entity =>
            {
                entity.HasKey(e => e.CovidPasosId);

                entity.ToTable("CovidPasos");

                entity.Property(e => e.CovidPasosId).HasColumnName("CovidPasosId");

                entity.Property(e => e.DatumIzdavanja)
                    .IsRequired()
                    .HasColumnType("datetime");

                entity.Property(e => e.DatumVazenja)
                 .IsRequired()
                 .HasColumnType("datetime");

                entity.Property(e => e.VazeciPasos)
                  .IsRequired()
                  .HasMaxLength(10);
