...
namespace eProdaja.Database
{
    public partial class eProdajaContext
    {
        partial void OnModelCreatingPartial(ModelBuilder modelBuilder)
        {
            ...
            //CovidPasos
            modelBuilder.Entity<CovidPasos>().HasData(new eProdaja.Database.CovidPasos()
            {
                CovidPasosId = 1,
                DatumIzdavanja = new DateTime(2020, 6, 13, 14, 29, 51, 650, DateTimeKind.Local),
                DatumVazenja = new DateTime(2022, 6, 13, 14, 29, 51, 650, DateTimeKind.Local),
                VazeciPasos = "DA",
            });
            modelBuilder.Entity<CovidPasos>().HasData(new eProdaja.Database.CovidPasos()
            {
                CovidPasosId = 2,
                DatumIzdavanja = new DateTime(2020, 7, 13, 14, 29, 51, 650, DateTimeKind.Local),
                DatumVazenja = new DateTime(2022, 7, 13, 14, 29, 51, 650, DateTimeKind.Local),
                VazeciPasos = "DA"
            });
            modelBuilder.Entity<CovidPasos>().HasData(new eProdaja.Database.CovidPasos()
            {
                CovidPasosId = 3,
                DatumIzdavanja = new DateTime(2020, 6, 13, 14, 29, 51, 650, DateTimeKind.Local),
                DatumVazenja = new DateTime(2021, 6, 13, 14, 29, 51, 650, DateTimeKind.Local),
                VazeciPasos = "NE"
            });
            modelBuilder.Entity<CovidPasos>().HasData(new eProdaja.Database.CovidPasos()
            {
